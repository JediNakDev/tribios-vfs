...
Engineering skills use five canonical triage roles.
This table maps each role to its GitHub label.
...
| `ready-for-human` | `ready-for-human` | Requires human action or judgment |
| `wontfix` | `wontfix` | Will not be actioned |

When a skill mentions a canonical role, use the corresponding GitHub label from this table.
Edit the GitHub label column if this repository adopts different label names.
